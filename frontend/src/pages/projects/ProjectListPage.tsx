...
import { Shield, Code2, TestTube2, Activity, Loader2, Lock } from 'lucide-react'
...
export function ProjectListPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      {/* Admin Access Button (prominent & separate) */}
      {isAdmin && (
        <div className="mb-8">
          <button
      ...
      {/* Note: "Todos os Projetos (somente leitura)" removed in favor of dedicated Admin button */}
