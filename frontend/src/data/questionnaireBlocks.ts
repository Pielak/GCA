...
export const BLOCKS: BlockDef[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: '17', label: 'Modelo de execução', help: 'Onde o sistema vai rodar? "Stand-alone" = máquina local. "Cloud" = nuvem. "Containerizado" = Docker/Kubernetes.', type: 'single', options: ['Stand-alone', 'On-premises', 'Cloud', 'Híbrido', 'Containerizado', 'Offline com sincronização posterior', NA_VALUE] },
