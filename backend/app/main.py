...
from app.routers.figma_router import router as figma_router
...
app.include_router(gatekeeper_passada_router, prefix=f"{settings.API_PREFIX}", tags=["gatekeeper-passada"])
...
app.include_router(figma_router, prefix=f"{settings.API_PREFIX}")
app.include_router(preview_router, prefix=f"{settings.API_PREFIX}")
